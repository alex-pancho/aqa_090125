...
class TestLogEvent(unittest.TestCase):
    ...
    def test_log_success(self, mock_get_logger):
        ...
        log_event("Kirill", "success")
        mock_logger.info.assert_called_once_with("Login event - Username: Kirill, Status: success")
    ...
    def test_log_failed(self, mock_get_logger):
        ...
        mock_logger.error.assert_called_once_with("Login event - Username: Anna, Status: failed")
