...
filtered_cars = [(brends, *details)for brends, details in car_data.items()
                 if details[1]>=search_criteria[1] and details[2]>=search_criteria[2 and details[4]<=search_criteria[2]]]
sorted_car = sorted(filtered_cars, key=lambda x: x[5])
result = sorted_car[0:5]
print(result)