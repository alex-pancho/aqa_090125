...
#типом автомобіля та ціною. Маємо критерії пошуку у вигляді кортежу
#(рік ≥, об'єм двигуна ≥, ціна ≤). Напишіть код, який допоможе нам отримати автомобілі, 
#які відповідають критеріям пошуку. Автомобілі повинні бути відсортовані за зростанням ціни. 
...
car_list = []
for car in car_data:
    if car_data[car][1] >= search_criteria[0] and car_data[car][2] >= search_criteria[1] and car_data[car][4] <= search_criteria[2]:
        car_list.append((car, car_data[car][4]))
