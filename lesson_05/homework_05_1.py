...
filtered_cars = filter(lambda car: car[1][1] >= search_criteria[0] and 
                                   car[1][2] >= search_criteria[1] and 
                                   car[1][4] <= search_criteria[2], 
                       car_data.items())
sorted_cars = dict(sorted(filtered_cars, key=lambda car: car[1][4])[:5])
print(f"Відповідь: {sorted_cars}")
