...
print("Total reees in the garden:", total_trees)
...
print("Evening temp:", evening_temp)
...
print("The kids in the group today:", children)
...
total_price_of_books = first_book + second_book + third_book
print("Total price of books:", total_price_of_books)